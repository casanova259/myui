...
export default function Projects() {
    ...
    //makign the refs to perform calculations 
    ...
    useEffect(()=>{
        ...
        const expandedSectionHeight=expandRowHeight*rows.length+sectionGap*(rows.length-1)+sectionPadding*2;
        ...
        function onScrollUpdate(){
            ...
            rows.forEach((row)=>{
                ...
                const width=rowStartWidth.current+(rowEndWidth.current-rowStartWidth.current)*prog;
