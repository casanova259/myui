        ...
        <section className="hero" ref={heroRef}>
          ...
          <div className="hero-fg-content" ref={fgContentRef}>
            ...
            <div className="hero-fg-header">
              <h1>Some Doors Only Open Upward.</h1>
            </div>
          ...
          <div className="hero-bg-content">
            <div className="hero-bg-content-col">
              <div className="hero-bg-content-copy" ref={bgCopyLeftRef}>
                <h3>The Body</h3>
                <p>
                  The rock doesn&apos;t care what you left at the bottom. It only asks what you&apos;re willing to lose to get higher.
                </p>
              </div>
            </div>
            ...
            <div className="hero-bg-content-col">
              <div className="hero-bg-content-copy" ref={bgCopyRightRef}>
                <h3>Mind</h3>
                <p>
                  Somewhere below, a version of you stayed comfortable. Somewhere above, a version of you stopped needing to be.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="hero-outro-content">
            ...
            <div className="hero-outro-header">
              <h3 className="hero-outro-line" ref={outroHeaderRef}>
                The Descent Is Where You Find Out What The Climb Was For.
              </h3>
            </div>
          </div>
        </section>
