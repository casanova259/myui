...
const SKETCH_STROKES: StrokePath[] = [
    ...
    // circle inside left panel (planet sketch)
    ...
    // right top squiggle lines (stats)
    ...
    // red annotation arrow pointing at circle
...
// ── tiny star field: seeded positions so they're stable ──────────────────────
...
export default function RawCanvas() {
    ...
    const runAnimation = () => {
        ...
        // 1 — paper fades in with sketch group
        ...
        // 4 — sketch fades to black, polished snaps in
        ...
        // 5 — stagger polished children in
    ...
    const handleMetricHover = (e: React.MouseEvent<SVGGElement>, isEnter: boolean) => {
        // Only allow interactions when the OS is fully "rendered"
        ...
        <div style={{ background: "#f0ede8", borderRadius: 20, padding: "2rem", display: "flex", flexDirection: "column", alignItems: "center", gap: "1.25rem", fontFamily: "system-ui, sans-serif" }}>
            ...
            <div style={{ width: "100%", maxWidth: 620, borderRadius: 14, overflow: "hidden", position: "relative", aspectRatio: "620/400" }}>
                ...
                <svg viewBox="0 0 620 400" width="100%" style={{ display: "block" }} xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* ── notebook paper bg (sketch phase) ── */}
                    ...
                    <g ref={polishedGroupRef} style={{ opacity: 0 }}>
                        ...
                        <g id="constellations">
                            {CONSTELLATION_LINES.map(([a, b], i) => (
                                <line
                                    ...
                                    stroke="#5dcaa5" strokeWidth={0.4} strokeOpacity={0.3}
                                />
                            ))}
                        </g>
                        ...
                        {/* right top panel — signal metrics */}
                        <g id="metrics-panel">
                            ...
                            {/* metric rows with tactile hover */}
                            {[
                                ...
                                <g 
                                    ...
                                    style={{ 
                                        cursor: phase === "polished" ? "pointer" : "default", 
                                        opacity: 0.7 
                                    }}
                                >
